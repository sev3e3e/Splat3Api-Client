 ...
 *
 * The version of the OpenAPI document: 0.0.18-alpha
 * 
 *
...
export function ScheduleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Schedule {
    ...
    return {
        ...
        'rule': json['rule'],
        'stages': (json['stages'] === null ? null : (json['stages'] as Array<any>).map(ScheduleStagesInnerFromJSON)),
    };
}
...
export function ScheduleToJSON(value?: Schedule | null): any {
    ...
    return {
        ...
        'rule': value.rule,
        'stages': (value.stages === null ? null : (value.stages as Array<any>).map(ScheduleStagesInnerToJSON)),
    };
}
